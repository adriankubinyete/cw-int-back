...
export async function workflowsRoutes(app: FastifyInstance) {
    ...
    app.post("/workflows", async (request, reply) => {
        ...
        routeLogger.info("workflow created", { userId: request.user.userId, workflowId: workflow.id });
    ...
    app.patch("/workflows/:id/toggle", async (request, reply) => {
        ...
        routeLogger.info("workflow toggled", { id, userId: request.user.userId, active: workflow.isActive });
        return workflow;
    });
